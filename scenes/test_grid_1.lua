...
function SceneGridTest:initialize()
    ...
    self.r0:grid_config{col=1, row=1, colspan=2, rowspan=2}
    ...
    self.r1:grid_config{col=3, row=1, sticky="NS"}
    ...
    self.r2:grid_config{col=1, row=3, sticky="NSWE"}
    ...
    self.r3:grid_config{col=2, row=3, sticky="NSWE"}
